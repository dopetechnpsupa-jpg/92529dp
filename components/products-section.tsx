...
const ProductsSection = memo(function ProductsSection({ products, onAddToCart, isLoading = false }: ProductsSectionProps) {
            ...
            {categories.map((category, index) => {
              ...
              return (
                <button
                  ...
                  onClick={() => handleCategoryChange(category?.id || 'all')}
                ...
                >
                  ...
                  <span className="text-sm sm:text-base font-medium">{category?.name || 'Unknown'}</span>
                </button>
              )
            })}
            </div>
