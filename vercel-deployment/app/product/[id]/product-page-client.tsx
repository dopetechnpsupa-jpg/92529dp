            ...
            <div className="bg-black/50 backdrop-blur-sm p-3 sm:p-4 rounded-lg border border-[#F7DD0F]/20">
             ...
             <div className="flex flex-col sm:flex-row gap-3 sm:gap-3">
               <Button
                 ...
                 className="w-full sm:flex-1 border-2 border-[#F7DD0F] rounded-md bg-transparent hover:bg-[#F7DD0F]/10 text-white py-5 sm:py-6 text-lg sm:text-base font-semibold shadow-md hover:shadow-xl transition-all duration-300 transform hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-[#F7DD0F]/50 active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed"
               >
                 Add to cart
               </Button>
               <Button
                 onClick={handleBuyNow}
                 className="w-full sm:flex-1 border-2 border-[#F7DD0F] rounded-md bg-[#F7DD0F] hover:bg-[#F7DD0F]/90 text-black py-5 sm:py-6 text-lg sm:text-base font-semibold shadow-md hover:shadow-xl transition-all duration-300 transform hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-[#F7DD0F]/50 active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed"
               >
                 Buy now
               </Button>
             </div>
